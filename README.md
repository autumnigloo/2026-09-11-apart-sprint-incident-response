...
Every leak of 100 tokens or more that was not paraphrased was found, for every type. The 29 misses at 0.35: 21 are 25-token leaks, 6 paraphrases, 2 short prose. The convergence rule and the evidence floor are each a measured dial; see the K sweep and floor ablation in [`RESULTS.md`](RESULTS.md).
</details>
