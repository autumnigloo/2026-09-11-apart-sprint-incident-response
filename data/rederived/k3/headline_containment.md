...
Threshold t* = 0.25 (lowest threshold with precision >= 0.95). At t*: precision 0.9704, recall 0.9825, 12 false-positive hits across 400 cases, 4853 negative pairs scored > 0.

Detector: char 5-grams, MinHash 128 perms, source window 100 chars, origination filter ON, convergence filter K=3, evidence floor 40, target-origination filter OFF.
...
| type | 25 | 50 | 100 | 200 | 500 |
|---|---|---|---|---|---|
| prose | 1.00 (n=5) | 1.00 (n=5) | 0.60 (n=5) | 1.00 (n=5) | 1.00 (n=5) |
| code | 0.80 (n=5) | 0.80 (n=5) | 0.80 (n=5) | 1.00 (n=5) | 1.00 (n=5) |
| structured | 0.60 (n=5) | 1.00 (n=5) | 1.00 (n=5) | 1.00 (n=5) | 1.00 (n=5) |
| terse | 0.80 (n=5) | 1.00 (n=5) | 1.00 (n=5) | 1.00 (n=5) | 1.00 (n=5) |
...
|---|---|---|---|
| 0.05 | 0.2176 | 1.0 | 1438 |
| 0.1 | 0.5168 | 1.0 | 374 |
| 0.15 | 0.7215 | 0.9975 | 154 |
| 0.2 | 0.9475 | 0.9925 | 22 |
| 0.25 | 0.9704 | 0.9825 | 12 |
| 0.3 | 0.9872 | 0.9675 | 5 |
| 0.35 | 0.9922 | 0.95 | 3 |
| 0.4 | 1.0 | 0.9325 | 0 |
| 0.45 | 1.0 | 0.8975 | 0 |
